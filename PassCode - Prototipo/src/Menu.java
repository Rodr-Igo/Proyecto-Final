...
public class Menu
{
    public static void AbrirMenu(String matriz[][])
    {
        /*
Funcion:AbrirMenu
Descripcion: Entra a un ciclo while que selecciona distinas opciones usando el char "opcion" para moverse entre distinas
funciones para modificar la matriz.
