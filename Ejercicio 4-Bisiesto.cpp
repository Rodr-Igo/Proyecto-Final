/*
Autor:Mois�s Vinajera 29/Enero/17
...
Se considera la definici�n de redondeo de centana hacia el valor mayor m�s cercano al valor le�do.
...
int main(int argc, char *argv[])
{
	...
	valorRedondeado = La centana m�s cercana a la cual se va a redondear.
	*/
	float valor;
